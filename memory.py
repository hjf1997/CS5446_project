...
class Memory_With_TDError(object):
    ...
    def sample(self, batch_size, net, target_net, beta, device):
        ...
        td_error = PerNet.get_td_error(net, target_net, batch.state, batch.next_state, batch.action, batch.reward, batch.mask, device)
